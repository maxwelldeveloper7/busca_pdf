# Licença - Creative Commons BY-NC-SA 4.0 International

© 2025 Maxwell de Oliveira Chaves  
**Projeto:** Aplicativo em Python para busca e filtragem de conteúdo em múltiplos arquivos PDF educacionais.  
...
- **Atribuição:**  
  É obrigatório dar crédito apropriado a **Maxwell de Oliveira Chaves**, fornecer um link para esta licença e indicar se mudanças foram feitas.  
  O crédito não deve sugerir que o autor endossa você ou o uso do material.

- **NãoComercial:**  
  Você **não pode usar o material para fins comerciais**.

- **CompartilhaIgual:**  
  Se você remixar, transformar ou criar a partir do material, deverá distribuir suas contribuições sob a **mesma licença**.
